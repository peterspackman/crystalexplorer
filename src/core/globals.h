...
inline constexpr const char *authors =
    "P.R. Spackman, M. J. Turner, J. J. McKinnon, S. K. Wolff, D. "
    "J. Grimwood, D. Jayatilaka and M. A. Spackman";
...
inline constexpr const char *gitUrl = "https://github.com/peterspackman/crystalexplorer";
