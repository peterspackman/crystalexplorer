...
public:
  ...
  // Average properties
  double
  averageBulkModulus(occ::core::ElasticTensor::AveragingScheme scheme =
                         occ::core::ElasticTensor::AveragingScheme::Hill) const;
  double averageShearModulus(
      occ::core::ElasticTensor::AveragingScheme scheme =
          occ::core::ElasticTensor::AveragingScheme::Hill) const;
  double averageYoungsModulus(
      occ::core::ElasticTensor::AveragingScheme scheme =
          occ::core::ElasticTensor::AveragingScheme::Hill) const;
  double averagePoissonRatio(
      occ::core::ElasticTensor::AveragingScheme scheme =
          occ::core::ElasticTensor::AveragingScheme::Hill) const;
