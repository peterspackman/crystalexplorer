...
public:
  ...
  explicit MeshInstanceVertex(const QVector3D &translation,
                              ...
                              int propertyIndex = 0, float alpha = 1.0)
  ...
  static constexpr int translationOffset() {
    return offsetof(MeshInstanceVertex, m_translation);
  }
  static constexpr int rotation1Offset() {
    return offsetof(MeshInstanceVertex, m_rotation1);
  }
  static constexpr int rotation2Offset() {
    return offsetof(MeshInstanceVertex, m_rotation2);
  }
  static constexpr int rotation3Offset() {
    return offsetof(MeshInstanceVertex, m_rotation3);
  }
  static constexpr int selectionIdOffset() {
    return offsetof(MeshInstanceVertex, m_selection_id);
  }
  static constexpr int propertyIndexOffset() {
    return offsetof(MeshInstanceVertex, m_propertyIndex);
  }
  static constexpr int alphaOffset() {
    return offsetof(MeshInstanceVertex, m_alpha);
  }
