...
static const ColorScheme availableColorSchemes[] = {
    ColorScheme::noneColor,         ColorScheme::RedGreenBlue,
    ColorScheme::RedWhiteBlue,      ColorScheme::OrangeWhitePurple,
    ColorScheme::Qualitative14Dark, ColorScheme::Qualitative14Light,
    ColorScheme::SpectralRainbow,   ColorScheme::Rainbow,
    ColorScheme::Viridis,           ColorScheme::Magma,
    ColorScheme::MaterialDesign};

constexpr const char *colorSchemeName(ColorScheme s) {
  switch (s) {
  ...
  return "Unknown colorscheme";
}

inline ColorScheme colorSchemeFromString(const QString &s) {
  for (const auto &scheme : availableColorSchemes) {
    if (colorSchemeName(scheme) == s)
      return scheme;
  }
  return ColorScheme::Rainbow;
}

const QColor COLORSCHEME_RED = QColor(255, 0.0, 0.0, 255);
const QColor COLORSCHEME_BLUE = QColor(0.0, 0.0, 255, 255);
const QColor COLORSCHEME_WHITE = QColor(255, 255, 255, 255);
const QColor COLORSCHEME_ORANGE = QColor(255, 127, 0, 255);
const QColor COLORSCHEME_PURPLE = QColor(153, 50.0, 204, 255);
const float REDGREENBLUE_MAXHUE = 240.0;
const float REDGREENBLUE_MINHUE = 0.0;
const float RAINBOW_MAXHUE = 359.0;
const float RAINBOW_MINHUE = 0.0;

// Spectral rainbow scheme taken0from:
// http://colorbrewer2.org/
const QColor SPECTRALRAINBOW_3[]{QColor(252, 141, 89), QColor(255, 255, 191),
                                 QColor(153, 213, 148)};

const QColor SPECTRALRAINBOW_4[]{QColor(215, 25, 28), QColor(253, 174, 97),
                                 QColor(171, 221, 164), QColor(43, 131, 186)};

const QColor SPECTRALRAINBOW_5[]{QColor(215, 25, 28), QColor(253, 174, 97),
                                 QColor(255, 255, 191), QColor(171, 221, 164),
                                 QColor(43, 131, 186)};

const QColor SPECTRALRAINBOW_6[]{QColor(213, 62, 79),   QColor(252, 141, 89),
                                 QColor(254, 224, 139), QColor(230, 245, 152),
                                 QColor(153, 213, 148), QColor(50, 136, 189)};

const QColor SPECTRALRAINBOW_7[]{QColor(213, 62, 79),   QColor(252, 141, 89),
                                 QColor(254, 224, 139), QColor(255, 255, 191),
                                 QColor(230, 245, 152), QColor(153, 213, 148),
                                 QColor(50, 136, 189)};

const QColor SPECTRALRAINBOW_8[]{QColor(213, 62, 79),   QColor(244, 109, 67),
                                 QColor(253, 174, 97),  QColor(254, 224, 139),
                                 QColor(230, 245, 152), QColor(171, 221, 164),
                                 QColor(102, 194, 165), QColor(50, 136, 189)};

const QColor SPECTRALRAINBOW_9[]{
...
// 14 qualitative colors taken0from
// http://tools.medialab.sciences-po.fr/iwanthue/
const int QUALITATIVE14_SIZE = 14; // number of colors in scheme
                                   //
const QColor QUALITATIVE_DARK_14[]{
...
const QColor QUALITATIVE_LIGHT_14[]{
...
const int MATERIAL_DESIGN_SIZE = 20; // number of colors in scheme

const QColor MATERIAL_DESIGN_PALETTE_20[]{
...
const int MAGMA_SIZE = 256; // number of colors in scheme
...
const int VIRIDIS_SIZE = 256; // number of colors in scheme

const QColor VIRIDIS[]{
...
class ColorSchemer {
public:
  static QColor color(ColorScheme, float, float, float, bool reverse = false);
  static QColor getNoneColor();

private:
  static QColor colorMappedFromHueRange(float, float, float, bool, float,
                                        float);
  static QColor colorMappedFromColorRange(float, float, float, QColor, QColor,
                                          QColor);
  static QColor colorAsQualitative14Dark(float, float, float);
  static QColor colorAsQualitative14Light(float, float, float);
  static QColor colorAsSpectralRainbow(float, float, float);
  static QColor colorAsViridis(float, float, float);
  static QColor colorAsMagma(float, float, float);
  static QColor colorAsMaterialDesign20(float, float, float);
};
